# ExportHUB Professional 0.7 – Anmeldung & Mandantenzuordnung

## Sicherheitsprinzip

Professional 0.7 besitzt erstmals eine serverseitige Identity-Schicht. Der Browser entscheidet weder Mandant noch Rolle selbst. Eine erfolgreiche Anmeldung wird aus **Workspace + Anmeldename + Passwort** serverseitig gegen `tenants`, `app_users`, `tenant_memberships` und `app_user_auth` aufgelöst.
...
0.7 implementiert absichtlich nur das **Erst-Onboarding** einer Plattforminstanz. Es benötigt:
