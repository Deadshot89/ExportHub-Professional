...
function error(context,err,status){
  ...
  const map={
    INPUT_INVALID:400,LOGIN_INVALID:400,PASSWORD_TOO_SHORT:400,PASSWORD_TOO_LONG:400,TENANT_SLUG_INVALID:400,
    AUTH_INVALID:401,SESSION_INVALID:401,SESSION_EXPIRED:401,AUTH_LOCKED:423,BOOTSTRAP_DENIED:403,ONBOARDING_ALREADY_COMPLETED:409,
